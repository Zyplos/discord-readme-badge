...
<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="382" height="187" viewBox="0 0 382 187">
  ...
  <text id="username-text" class="cls-3" transform="translate(94.66 43.89)">${this.username}</text>
  <g id="game-text">
    <text class="cls-4" transform="translate(94.66 67.11)">${this.gameType} ${this.game}</text>
  </g>
  <g id="pfp-group">
    <g id="pfp-clip-group">
      <g class="cls-7">
